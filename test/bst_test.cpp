...
{
    auto const a = binary_search_tree<int>{0, 1, 2};
    auto const b = binary_search_tree<int>{0, 1, 2};
    auto const c = binary_search_tree<int>{0, 1, 1};
    auto const d = binary_search_tree<int>{0, 1, 3};
