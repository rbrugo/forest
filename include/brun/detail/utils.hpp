...
private:
    ...
    using type   = typename std::is_convertible<typename traits::iterator_category, std::input_iterator_tag>::type;
public:
...
struct _node_deallocator
{
    ...
    constexpr inline void operator()(typename node_allocator_traits::pointer ptr) noexcept
    {
